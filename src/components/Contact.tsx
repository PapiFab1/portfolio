...
export default function Contact() {
  return (
    <section id="contact" className="bg-gray-950 text-white py-16 sm:py-28 px-6 border-t border-white/5">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-3 mb-12">
          {links.map((link) => (
            ...
            >
              <span className="text-gray-500 group-hover:text-blue-100 text-xs tracking-[0.4em] uppercase transition-colors mb-1 sm:mb-0">
                {link.label}
              </span>
              <span className="text-sm text-gray-300 group-hover:text-white transition-colors break-all sm:break-normal">
                {link.display}
              </span>
            </a>
          ))}
