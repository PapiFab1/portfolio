...
export default function Hero({ onNavigate }) {
    ...
    return (_jsxs("section", { className: "relative h-screen overflow-hidden bg-black", children: [_jsx("video", { autoPlay: true, loop: true, muted: true, playsInline: true, className: "absolute inset-0 w-full h-full object-cover", children: _jsx("source", { src: "/background.mp4", type: "video/mp4" }) }), _jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-black/70 via-black/10 to-black/85" }), _jsx("div", { className: "absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-black to-transparent" }), _jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsxs("div", { className: "flex flex-col -translate-x-[8%]", children: [_jsx("p", { className: "text-white text-xs tracking-[0.6em] uppercase mb-5 font-medium", children: "\u2014 Portfolio" }), _jsxs("h1", { className: "text-6xl sm:text-7xl font-black text-white leading-none tracking-tight mb-2", children: ["Jonathan", _jsx("br", {}), "Fabien"] }), _jsx("p", { className: "text-blue-300 text-xs tracking-[0.5em] uppercase font-medium", children: "Software Engineer \u00B7 UCF '26" }), _jsx("nav", { className: "flex flex-col mt-10", onMouseLeave: () => setHovered(null), children: menuItems.map((item) => {
                                const isActive = item.id === activeId;
                                return (_jsxs("button", { onClick: () => onNavigate(item.id), onMouseEnter: () => setHovered(item.id), style: {
                                        ...
                                        transition: 'font-size 0.2s ease, opacity 0.2s ease',
                                    }, children: [isActive && (_jsx("span", { "aria-hidden": "true", style: {
                                                position: 'absolute',
                                                background: '#e8001c',
                                                width: '290px',
                                                height: '74px',
                                            ...
                                            } })), isActive && (_jsx("span", { "aria-hidden": "true", style: {
                                                position: 'absolute',
                                                background: '#ff2d78',
                                                width: '255px',
                                                height: '74px',
